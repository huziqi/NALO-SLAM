...
parser.add_argument('--do_crop', help='if set, crop input images as kitti benchmark images', action='store_true')
...
def test(params):
    ...
    with torch.no_grad():
        for img in tqdm(dataloader.data):
            image = Variable(img.cuda())
            # Predict
            #lpg8x8, lpg4x4, lpg2x2, reduc1x1, 
