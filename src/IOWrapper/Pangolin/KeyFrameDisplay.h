...
public:
	...
	bool refreshPC(bool canRefresh, float scaledTH, float absTH, int mode, float minBS, int sparsity, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud);
	void refreshPC();
...
private:
	...
	int numDensePoints;
	int numDenseBufferSize;
	InputDenseMap *originalInputDense;
	...
	bool dbufferValid;
	int dnumGLBufferPoints;
	int dnumGLBufferGoodPoints;
	pangolin::GlBuffer dvertexBuffer;
	pangolin::GlBuffer dcolorBuffer;
};
}
}
