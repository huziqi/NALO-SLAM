...
bool setting_useLidar = 1;
bool dense_track = 1;
float init_height = -1;
bool scale_fix = false;
float last_ScaleRate = -1;
std::deque<float> old_rate;
float last_gp[4] = {-1, -1, -1, -1};
bool setPlaneOptimize = true;
bool denseMapping=false;
...
bool setting_render_displayMask = true;
